...
class GradCAMVisualizer:
    ...
    def get_yolo_gradcam(self, image_tensor: torch.Tensor) -> np.ndarray | None:
        """
    ...
    def get_vit_gradcam(self, image: Image.Image, class_id: int,
                       normalization_params: dict) -> np.ndarray | None:
        """
    ...
    def visualize_yolo_gradcam(self, image: Image.Image) -> np.ndarray | None:
        """
    ...
    def create_gradcam_visualization_for_objects(self, image_path: str, detected_objects) -> np.ndarray | None:
        """
        ...
        try:
            ...
            for i, obj in enumerate(detected_objects):
                try:
                    ...
                    class_id = 1 if obj.class_name == 'boulder' else 0
