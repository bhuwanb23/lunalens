...
class LunarRiskCalculator:
    """
    Comprehensive Lunar Terrain Risk Calculator
    ...
    def calculate_roughness_risk_score(self, roughness_data: Dict[str, Any]) -> float:
        ...
        try:
            ...
            roughness_value = std_roughness if std_roughness > 0 else mean_roughness
    ...
    def calculate_curvature_risk_score(self, curvature_data: Dict[str, Any]) -> float:
        ...
        try:
            ...
            # Use profile curvature std as gradient indicator
            gradient_value = profile_curvature_std if profile_curvature_std > 0 else mean_curvature_std
...
if __name__ == "__main__":
    calculator = LunarRiskCalculator()
    
    # Example report paths (replace with actual paths)
    report_paths = [
    ...
    if existing_reports:
        ...
        results = calculator.process_analysis_reports(existing_reports)
        
        # Generate and display report
        report_content = calculator.generate_risk_report(results, "lunar_risk_analysis_report.txt")
        print("\n" + report_content)
