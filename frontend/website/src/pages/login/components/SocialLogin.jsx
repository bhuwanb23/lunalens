    ...
    <div className="flex items-center justify-center gap-3">
      {providers.map((provider) => (
        <button
          ...
          className="w-12 h-12 rounded-full border border-[#E2E8F0] bg-white hover:bg-gray-50 flex items-center justify-center transition-all duration-200 hover:shadow-sm active:scale-95"
        >
          {provider.icon}
        </button>
      ))}
