    ...
    <div className="w-full max-w-sm mx-auto">
      <div className="bg-white rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.08)] p-6 sm:p-8">
        <div className="text-center mb-5">
          <div className="w-10 h-10 bg-gradient-to-br from-[#1A7A6D] to-[#0D3B35] rounded-xl flex items-center justify-center mx-auto mb-3 shadow-lg">
            <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
            </svg>
          </div>
          <h1 className="text-xl font-bold text-[#1A2B3C] mb-0.5">
